    ...
    <section className='flexCenter flex-col'>
      <div className='padding-container max-container w-full pb-24'>
        ...
        lg:gap-10'>
          ...
          <p className='regular text-gray-30 xl:max-w-[520px]'>Only 
          with the hilink application you will no longer 
          get lost and get lost again, because we already support offline maps when 
        ...
        rounded-3xl border shadow-md md:left-[5%] lg:top-20'>
          ...
          <div className='flexBetween flex-col'>
            ...
            <div className='flex w-full flex-col'>
                ...
                <h4 className='bold-20 mt-2 whitespace-nowrap'>Wonorejo 
                Pasuruan</h4>
            </div>
          </div>
        </div>
